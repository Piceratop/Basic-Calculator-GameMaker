...
for (var _i = array_length(global.modes.Standard.equations) - 1; _i >= 0; _i--) {
	...
	draw_enclosed_text(
		...
		get_before_cursor_char_count(global.modes.Standard.equations[_i][0], global.modes.Standard.equations[_i][2]),
	...
	draw_enclosed_text(
		...
		get_before_cursor_char_count(global.modes.Standard.equations[_i][1], global.modes.Standard.equations[_i][3]),
...
draw_enclosed_text(
	...
	get_before_cursor_char_count(global.modes.Standard.current_equation, global.modes.Standard.current_equation_cursor_position),
