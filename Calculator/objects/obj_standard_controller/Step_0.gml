...
if (
	...
	if (keyboard_lastkey == vk_backspace) {
		global.modes.Standard.cursor_position = input_equation(global.modes.Standard.current_equation, "⌫", global.modes.Standard.cursor_position);
		...
		if (global.modes.Standard.current_equation_id == 0)
			global.modes.Standard.cursor_position = navigate_equations(
				_direction,
		...
		global.modes.Standard.cursor_position = input_equation(
